...
models = {
    ...
    "LogisticRegression": LogisticRegression(penalty='l2', C=1.0, 
                                                    ...
                                                    random_state=32), # Lower values of C= reduce overfitting
    "DecisionTreeClassifier": DecisionTreeClassifier(max_depth=4,  # Limits overfitting 
                                                    ...
                                                    criterion='gini', 
                                                    random_state=32), # prone to overfitting
    ...
    "StackingClassifier": StackingClassifier(estimators=[
        ('xgb', XGBClassifier(n_estimators=200, learning_rate=0.05, max_depth=4, random_state=32)), 
        ('cat', CatBoostClassifier(iterations=300, learning_rate=0.05, depth=5, verbose=0, random_state=32)), 
        ('rf', RandomForestClassifier(n_estimators=200, max_depth=6, random_state=32))], 
